...
export const days: Mission90Day[] = [
  ...
  d(11, 'networking-101', 'Networking 101 — IP, DNS, ports, curl', 55),
  d(12, 'networking-102', 'Networking 102 — ss, dig, ping, a troubleshooting flow', 50),
  d(13, 'ssh-deep-dive', 'SSH deep-dive — keys, config, scp, tunnels', 55),
  d(14, 'week-2-review-dns-detective', 'Week 2 review + DNS Detective', 45, { missionId: 'week2-dns-detective' }),
  d(15, 'shell-scripting-1', 'Shell scripting 1 — variables, conditionals, loops', 55),
  d(16, 'shell-scripting-2', 'Shell scripting 2 — functions, exit codes, a real backup script', 55),
  d(17, 'git-for-devops', 'Git for DevOps — branching, merge vs rebase', 50),
  d(18, 'git-collaboration', 'Git collaboration — PRs, reviews, tags, releases', 45),
  d(19, 'cron-scheduled-jobs', 'Cron & scheduled jobs — crontab, systemd timers', 45),
  d(20, 'phase-1-review', 'Phase 1 review — Linux interview drill', 45),

  // Phase 2 — Containers & CI/CD (days 21–45)
  d(21, 'week-3-review-locked-file', 'Week 3 review + The Locked File', 45, { missionId: 'week3-locked-file' }),
  d(22, 'containers-vs-vms', 'Containers vs VMs — what Docker actually does', 50),
  d(23, 'docker-fundamentals', 'Docker fundamentals — images, containers, registries', 55),
  d(24, 'dockerfiles', 'Dockerfiles — writing & optimizing your first image', 60),
  d(25, 'docker-networking', 'Docker networking & port mapping', 50),
  d(26, 'volumes-persistent-data', 'Volumes & persistent data', 50),
  d(27, 'docker-compose', 'docker compose — multi-container apps', 55),
  d(28, 'week-4-review-docker-rescue', 'Week 4 review + Docker Rescue', 45, { missionId: 'week4-docker-rescue' }),
  d(29, 'image-best-practices', 'Image best practices — multi-stage builds, size, security', 55),
  d(30, 'container-debugging', 'Container debugging — logs, exec, inspect, stats', 50),
  d(31, 'cicd-concepts', 'CI/CD concepts — pipelines, environments, artifacts (+ Jenkins legacy aside)', 45),
  d(32, 'github-actions-1', 'GitHub Actions 1 — workflow anatomy, triggers', 55),
  d(33, 'github-actions-2', 'GitHub Actions 2 — jobs, matrices, secrets', 55),
  d(34, 'github-actions-3', 'GitHub Actions 3 — build & push an image to a registry', 60),
  d(35, 'week-5-review', 'Week 5 review — harden your pipeline', 45),
  d(36, 'testing-in-pipelines', 'Testing in pipelines — lint, unit tests, quality gates', 50),
  d(37, 'versioning-releases', 'Versioning & releases — semver, tags, changelogs', 45),
  d(38, 'deploy-strategies', 'Deploy strategies — rolling, blue-green, canary', 45),
  d(39, 'pipeline-security', 'Pipeline security — secrets management, image scanning (Trivy), supply-chain basics', 50),
  d(40, 'phase-2-review-broken-pipeline', 'Phase 2 review + Broken Pipeline', 45, { missionId: 'week6-broken-pipeline' }),
