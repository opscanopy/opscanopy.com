...
export const testCategoryCopy: Record<string, TestCategoryCopy> = {
  ...
  'aws-ai-practitioner': {
    examCode: 'AIF-C01',
    metaDescription:
      'Two free 65-question AWS Certified AI Practitioner (AIF-C01) mock exams. Every answer explained: Bedrock, SageMaker AI, agentic AI, responsible AI, and AI security.',
    intro: [
      'AIF-C01 is a foundational exam: 65 questions in 90 minutes, 50 of them scored, and a scaled pass mark of 700 out of 1,000. It is written for people who use AI on AWS rather than build it — analysts, product managers, and developers adding AI literacy — and it asks for no code, no maths, and no hands-on configuration. Both mocks here follow exam guide v1.1 (April 2026), which added agentic AI, Amazon Bedrock AgentCore, Kiro, Strands Agents, and Amazon Nova to the syllabus.',
