...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'docker run command to compose',
      'docker run -p -v -e to compose',
      'docker run to compose yaml online',
      'free docker run to compose converter',
      'bidirectional docker run compose converter',
      'compose service to docker run',
      'docker run to docker-compose generator',
    ],
    accent: 'ship',
  },
  {
    ...
    keywords: [
      ...
      'gitlab pipeline validator',
      '.gitlab-ci.yml checker',
      'gitlab ci config validator no install',
      'validate gitlab ci before push',
  ...
  },
  {
    ...
    keywords: [
      ...
      'test prometheus relabel rules',
      'prometheus relabeling playground',
      'relabel_configs simulator',
      'prometheus relabel debugger',
      'metric_relabel_configs tester',
      'prometheus relabel keep drop tester',
      'prometheus relabel replace tester',
      'prometheus relabel hashmod tester',
      'prometheus labelmap tester',
  ...
  },
  {
    ...
    keywords: [
      ...
      'online alertmanager route tester',
      'alertmanager routing tree tester',
      'which alertmanager receiver matches',
      'test alertmanager routing config',
      'alertmanager route matcher tester',
      'amtool routes test online',
      'alertmanager route debugger',
      'alertmanager continue route tester',
      'alertmanager matchers tester',
      'test alertmanager routing without amtool',
      'simulate alertmanager alert routing',
    ],
    accent: 'ship',
  },
];
