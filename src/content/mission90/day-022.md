...
docker ps -a
# Output (CONTAINER ID, NAMES and timestamps will differ; the name is auto-generated):
...
#   cat /etc/os-release   -> PRETTY_NAME="Ubuntu 24.04.2 LTS"   (a tiny Ubuntu userland, no kernel of its own)
...
docker ps -a
# Output (IDs, names and times differ; note two 'ubuntu' rows, both Exited):
