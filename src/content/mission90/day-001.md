...
- **20 min** — Read §1 "Introduction to Linux" of the [Linux for DevOps guide](/learn/linux/linux-for-devops/#introduction-to-linux) for the wider story of why Linux runs effectively the entire server-side internet.
