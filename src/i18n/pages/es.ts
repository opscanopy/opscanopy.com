  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          'Más allá del script de analítica descrito arriba, mantenemos las dependencias externas al mínimo: las fuentes se alojan en nuestro propio sitio y las páginas no cargan ningún otro código de terceros. No incorporamos redes publicitarias ni píxeles de rastreo de redes sociales.',
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Asif Khan — desarrollador de software e ingeniero DevOps interesado en DevOps. Se propuso crear un recurso gratuito para nuevos desarrolladores e ingenieros DevOps que aprenden este camino, para que DevOps se pueda guiar y aprender fácilmente — ya que cuando él empezó, no existía un recurso gratuito así.',
