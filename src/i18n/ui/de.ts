...
const de: Partial<UiDict> = {
  ...
  'tool.trust': 'Läuft in Ihrem Browser — nichts, was Sie einfügen, verlässt diese Seite.',
  'tool.trustLink': 'Wie wir das belegen',
  ...
  'megamenu.explore': 'Entdecken',
  'megamenu.learnStrip': 'Learn — Roadmaps & Guides',
  'megamenu.installApp': 'App installieren',

  // PWA install CTA (revealed by beforeinstallprompt — see Layout.astro)
  'install.appCta': 'OpsCanopy als App installieren',
  ...
  'faq.eyebrow': 'FAQ',
  'faq.heading': 'Fragen, beantwortet.',
  'faq.tapHint': 'Tippen Sie auf eine Frage, um die Antwort aufzuklappen.',
  ...
  'crosslinks.relatedTools': 'Verwandte Tools',
  ...
  'palette.placeholder': 'Zu einem Tool springen…',
  'palette.searchLabel': 'Tools durchsuchen',
  'palette.empty': 'Keine Tools gefunden.',
  'palette.hintNav': 'Navigieren',
  ...
  // Blog
  'blog.metaTitle': 'Blog — Notizen zu DevOps, CI/CD und Observability',
  ...
  'search.shortcutHint': 'Strg+K oder ⌘K',
