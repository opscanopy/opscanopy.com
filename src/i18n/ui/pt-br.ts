...
const ptBr: Partial<UiDict> = {
  ...
  'tool.trust': 'Roda no seu navegador — nada do que você cola sai desta página.',
  'tool.trustLink': 'Como comprovamos isso',
  ...
  'crosslinks.relatedTools': 'Ferramentas relacionadas',
  ...
  // Blog
  'blog.metaTitle': 'Blog — notas de campo sobre DevOps, CI/CD e observabilidade',
  ...
  'search.shortcutHint': 'Ctrl+K ou ⌘K',
